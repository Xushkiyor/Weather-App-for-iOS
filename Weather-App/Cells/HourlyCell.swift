...
class HourlyCell: UICollectionViewCell {
    ...
    static var reuseIdentifier = "HourlyCell"
    ...
    func layoutViews() {
        hourlyTimeLabel.topAnchor.constraint(equalTo: topAnchor, constant: 4).isActive = translatesAutoresizingMaskIntoConstraints
    ...
    func configure(with item: WeatherInfo) {
        ...
        tempLabel.text = String(item.temp.kelvinToCelciusConvertor()) + " °C"
    }
}
